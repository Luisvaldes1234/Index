...
// --- 3. LÓGICA DE MAPAS (Solo para Registro y Visualización) ---
...
// SIMPLIFICADO: La función de guardar ya no necesita manejar coordenadas de un modal
...
// SIMPLIFICADO: El formulario de edición ya no tiene botón para el mapa
    ...
    card.innerHTML = `
        ...
        <div class="space-y-4">
            ...
            <div>
                ...
                <p class="text-xs text-gray-500 mt-1">Nota: Para cambiar la ubicación en el mapa, debe eliminar y registrar la máquina de nuevo.</p>
            </div>
